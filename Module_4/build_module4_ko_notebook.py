#!/usr/bin/env python3
"""Build Korean notebook from English Module 4 RAG notebook."""
...
from _module4_ko_translations import MARKDOWN_KO, PRINT_REPLACEMENTS

SRC = Path(__file__).with_name(
    "Module_4_Building_a_comprehensive_RAG_system.ipynb"
)
DST = Path(__file__).with_name(
    "Module_4_Building_a_comprehensive_RAG_system_KO.ipynb"
)
...
def _literal_newline_pairs(english: str, korean: str) -> list[tuple[str, str]]:
